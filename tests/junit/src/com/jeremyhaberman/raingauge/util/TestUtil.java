...
public class TestUtil {
	...
	public static void clearContentProvider(Context context) {
		context.getContentResolver().delete(RainGaugeProviderContract.ObservationsTable.CONTENT_URI, null, null);
		context.getContentResolver().delete(RainGaugeProviderContract.WateringsTable.CONTENT_URI, null, null);
	}
}
