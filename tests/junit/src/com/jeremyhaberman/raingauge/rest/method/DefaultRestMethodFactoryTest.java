...
public class DefaultRestMethodFactoryTest extends AndroidTestCase {
    ...
    public void testGetInstance() {
        RestMethodFactory factory = DefaultRestMethodFactory
                .getInstance(getContext());
        assertNotNull(factory);

        // We should get the same factory back on subsequent calls
        RestMethodFactory factory2 = DefaultRestMethodFactory
                .getInstance(getContext());
    ...
    public void testGetRestMethodForObservations() {
        ...
        RestMethod<Observations> method = (RestMethod<Observations>) factory
    ...
    public void testGetRestMethodForForecast() {
        ...
        @SuppressWarnings("unchecked")
        RestMethod<Forecast> method = (RestMethod<Forecast>) factory
    ...
    public void testGetRestMethodForObservationsWithInvalidMethod() {
        ...
        try {
            factory.getRestMethod(RestMethodFactory.RESOURCE_TYPE_OBSERVATIONS,
                    Method.POST, params);
    ...
    public void testGetRestMethodForForecastWithInvalidMethod() {
        ...
        try {
            factory.getRestMethod(RestMethodFactory.RESOURCE_TYPE_FORECAST,
                    Method.POST, params);
            fail("Should have thrown IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            assertNotNull(e);
    ...
    public void testGetRestMethodWithInvalidUri() {
        ...
        try {
            factory.getRestMethod(4, Method.GET, params);
            fail("Should have thrown IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            assertNotNull(e);
        }
