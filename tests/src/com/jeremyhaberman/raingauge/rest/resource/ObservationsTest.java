...
public class ObservationsTest extends TestCase {
	...
	public void testObservations() {
		Observations observations = Observations.createObservations(System.currentTimeMillis(), 0.5);
		assertNotNull(observations);
	}

	public void testNegativeRainfall() {
		try {
			Observations observations = Observations.createObservations(System.currentTimeMillis(), -1);
	...
	public void testGetRainfall() {
		double expected = 0.5;
		Observations observations = Observations.createObservations(System.currentTimeMillis(), expected);
	...
	public void testEquals() {
		...
		assertFalse(observations1.equals(Observations.createObservations(System.currentTimeMillis(), 0.3)));
	...
	public void testHashCode() {
		...
		Observations observations4 = Observations.createObservations(System.currentTimeMillis(), 0.4);
